<template> 
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="类型名称：">
            <el-input v-model="listQuery.type" class="input-width" placeholder="类型名称"></el-input>
          </el-form-item>
        </el-form>
      </div>
    </el-card>
    <el-card class="operate-container" shadow="never">
      ...
      <span>数据列表</span>
      <el-button size="mini" class="btn-add" @click="handleAdd()">添加试题类型</el-button>
    </el-card>
...
<script>
  import {fetchList,deleteType} from '@/api/questionType';
